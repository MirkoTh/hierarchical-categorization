...
- Second, pull the following github repo: https://github.com/MirkoTh/rutils and install the package from source or use the devtool package and install rutils as follows: devtools::install("your-selected-path\\rutils")
